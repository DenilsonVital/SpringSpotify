...
import br.unipe.spotunipe.service.MusicaService;
...
public class MusicaController {
	...
	@GetMapping("/listar")
	public ModelAndView listar(@PathVariable("playlistId") long playlistId, ModelMap model) {//o PathVariable serve para recuperar o id da playlist passado na url
